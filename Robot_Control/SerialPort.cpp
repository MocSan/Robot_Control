...
//---------------------------------------------------------------------------------
BOOL SerialPort::InitPort(CWnd* pPortOwner,	// the owner (CWnd) of the port (receives message)
...
//---------------------------------------------------------------------------------
BOOL SerialPort::RestartMonitoring()
{
...
//---------------------------------------------------------------------------------
BOOL SerialPort::StopMonitoring()
{
...
void SerialPort::WriteToPort(char* string, int n)
{
	assert(m_hComm != 0);
...
void SerialPort::WriteToPort(LPCTSTR string)
{
	assert(m_hComm != 0);
...
void SerialPort::WriteToPort(LPCTSTR string, int n)
{
	assert(m_hComm != 0);
...
//---------------------------------------------------------------------------------
DWORD SerialPort::GetCommEvents()
{
